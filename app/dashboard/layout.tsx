...
import { Menu, X, User, Settings, Home, Bell, LogOut } from 'lucide-react';
          ...
          <div className="lg:hidden bg-white border-b shadow-lg">
            <nav className="px-4 py-3 space-y-2">
              ...
              <button
                ...
                className="flex items-center space-x-3 px-3 py-2 text-gray-700 hover:bg-gray-100 rounded-md w-full text-left"
              >
